(function (fn){
    ...
    fn.use = function (req, res, next) {
        res.locals.helpers = res.locals.helpers || {};

        res.locals.helpers.xhr = req.xhr;
        res.locals.helpers.isAjax = function () { return req.xhr; };
        res.locals.helpers.qs = req.query;
    };
